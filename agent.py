...
root_agent = Agent(
    ...
    description="Agent to answer questions about the standard operating procedure for Those Who Care (TWC).",
    instruction="I can answer your questions about the SOP you are asking for.",
