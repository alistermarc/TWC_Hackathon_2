...
rag_agent = Agent(
    ...
    Remember, your primary goal is to help users access and manage information through RAG capabilities. If the user query is about SOP, go back to the manager. 
    """,
)
